...
export const PROGRAM_INFO_BY_ID: { [address: string]: ProgramInfo } = {
    ...
    // Gorbagana Associated Token Account program
    '9S3cCu3JThRhKMD1QNf4WVrWzmzy1caUEFN8LaszSBnm': {
        deployments: [Cluster.Custom],
        name: PROGRAM_NAMES.ASSOCIATED_TOKEN,
    },
    // native built-ins
    ...
    // Gorbagana custom token programs
    GhCZfX98EqFNZoKzbW7psCjDkFg7WcZRBMkr5gFxA6uj: {
        deployments: [Cluster.Custom],
        name: PROGRAM_NAMES.TOKEN,
    },
    '3LfFqp4WFYy8gc9TiysgSxh9i8TCqrmvUuxuawyA3f2S': {
        deployments: [Cluster.Custom],
        name: PROGRAM_NAMES.TOKEN_2022,
    },
...
export const SPECIAL_IDS: { [key: string]: string } = {
    ...
    // Gorbagana custom programs
    GhCZfX98EqFNZoKzbW7psCjDkFg7WcZRBMkr5gFxA6uj: 'Gorbagana Token Program',
    '3LfFqp4WFYy8gc9TiysgSxh9i8TCqrmvUuxuawyA3f2S': 'Gorbagana Token-2022 Program',
    '9S3cCu3JThRhKMD1QNf4WVrWzmzy1caUEFN8LaszSBnm': 'Gorbagana Associated Token Program',
};

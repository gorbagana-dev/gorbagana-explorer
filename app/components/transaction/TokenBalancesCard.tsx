    ...
    return (
        <div className="card-refined">
            <div className="card-refined-header">
                <h4 className="card-refined-title">Token Balances</h4>
            </div>
                    ...
                    <table className="table-refined">
                        <thead>
                            <tr>
                                ...
                                <th className="table-refined-label">Token</th>
                                <th className="table-refined-label">Change</th>
                                <th className="table-refined-label">Post Balance</th>
                            </tr>
                        </thead>
                        <tbody>
                            {rows.map(row => (

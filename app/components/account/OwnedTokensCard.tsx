        ...
        <>
            ...
            <div className="card-refined">
                <div className="card-refined-header">
                    <h4 className="card-refined-title">Token Holdings</h4>
                ...
                <div className="card-refined-body">
                    <div className="table-refined-wrapper">
                        <table className="table-refined">
                            <thead>
                                <tr>
                                    {showLogos && <th className="table-refined-label text-center">Logo</th>}
                                    {display === 'detail' && <th className="table-refined-label">Account Address</th>}
                                    <th className="table-refined-label">Mint Address</th>
                                    <th className="table-refined-label">{display === 'detail' ? 'Total Balance' : 'Balance'}</th>
                                </tr>
                            </thead>
                            {display === 'detail' ? (
...
const DisplayDropdown = ({ display, toggle, show }: DropdownProps) => {
    ...
    return (
        <div className="dropdown">
            <button className="btn-refined btn-refined-secondary" type="button" onClick={toggle}>
                {display === 'detail' ? 'Detailed' : 'Summary'} <ChevronDown size={13} />
            </button>

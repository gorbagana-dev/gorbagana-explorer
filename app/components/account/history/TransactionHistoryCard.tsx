            ...
            <div className="card-refined-body">
                <div className="table-refined-wrapper">
                    <table className="table-refined">
                        <thead>
                            <tr>
                                <th className="table-refined-label">Transaction Signature</th>
                                <th className="table-refined-label">Block</th>
                                {hasTimestamps && (
                                    <>
                                        <th className="table-refined-label">Age</th>
                                        <th className="table-refined-label">Timestamp</th>
                                    </>
                                )}
                                <th className="table-refined-label">Result</th>
                            </tr>
                        </thead>
                        <tbody>{detailsList}</tbody>
                    </table>
                </div>
            </div>

        ...
        <>
            <div className="card-refined">
                <div className="card-refined-header">
                    <h4 className="card-refined-title">Transaction Overview</h4>
                    <button className="btn-refined btn-refined-secondary" onClick={onClear}>
                        Clear
                    </button>
                </div>
                <div className="card-refined-body">
                    <table className="table-refined">
                        <tbody>
                            <tr>
                                <td className="table-refined-label">Serialized Size</td>
                            ...
                            <tr>
                                <td className="table-refined-label">Fees</td>
                                <td className="table-refined-value">
                                    <div className="d-flex align-items-end flex-column">
                            ...
                            <tr>
                                <td className="table-refined-label">
                                    <div className="d-flex align-items-start flex-column">
                                        Fee payer
                                        <span className="mt-1">
                                            <span className="badge-refined me-2">Signer</span>
                                            <span className="badge-refined me-2">Writable</span>
                                        </span>
                                    </div>
                                </td>
                                <td className="table-refined-value">

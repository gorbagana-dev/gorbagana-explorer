    ...
    if (simulating) {
        return (
            <div className="card-refined">
                <div className="card-refined-header">
                    <h4 className="card-refined-title">Transaction Simulation</h4>
                </div>
                <div className="card-refined-body text-center">
                    <div className="skeleton-refined" style={{ width: '80px', height: '20px', margin: '0 auto' }}></div>
                </div>
            </div>
        );
    } else if (!logs) {
        return (
            <div className="card-refined">
                <div className="card-refined-header">
                    <h4 className="card-refined-title">Transaction Simulation</h4>
                    <button className="btn-refined btn-refined-primary" onClick={simulate}>
    ...
    return (
        <>
            <div className="card-refined">
                <div className="card-refined-header">
                    <h4 className="card-refined-title">Transaction Simulation</h4>
                    <button className="btn-refined btn-refined-secondary" onClick={simulate}>
                        Retry
                    </button>
                </div>
